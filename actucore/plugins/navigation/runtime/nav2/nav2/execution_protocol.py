...
def limit_forward_velocity(
    ...
    controller or smoother configuration can command reverse motion. Lateral
    and yaw components are preserved.
    """
...
def apply_motion_floor(velocity: Velocity) -> Velocity:
    """Compatibility wrapper for the default card motion limits."""

    return apply_motion_limits(
        velocity,
