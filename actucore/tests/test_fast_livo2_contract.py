...
class FastLivo2ContractTest(unittest.TestCase):
    ...
    def test_runtime_is_locked_inside_the_single_actucore_image(self) -> None:
        ...
        self.assertIn(
            "from g1_fast_livo2.camera_rgb_v2 import decode as decode_rgb",
            dockerfile,
        )
        self.assertIn(
            "from g1_fast_livo2.camera_depth_v2 import decode as decode_depth",
            dockerfile,
        )
        self.assertIn("assert RGB_MAGIC == DEPTH_MAGIC == b'PSE2'", dockerfile)
    ...
    def test_contract_exposes_bounded_relocalization_not_navigation(self) -> None:
        ...
        self.assertIn("_MAP_VIEW_POSE_REFRESH_HZ = 2.0", adapter)
