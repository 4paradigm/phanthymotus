...
class TensorRTNumpyTTSEngine:
    ...
    def _get_text_ids(self, text, *, normalized=False):
        from plugins.vits2_tts_trt.frontend import cleaned_text_to_sequence_mix
        from plugins.vits2_tts_trt.frontend.cleaner import clean_text_mix, g2p_normalized_text_mix
