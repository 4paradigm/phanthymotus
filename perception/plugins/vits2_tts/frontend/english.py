...
FRONTEND_DATA_DIR = os.getenv("VITS2_FRONTEND_DATA_DIR", current_file_path)
CMU_DICT_PATH = os.path.join(FRONTEND_DATA_DIR, "cmudict.rep")
CACHE_PATH = os.path.join(FRONTEND_DATA_DIR, "cmudict_cache.pickle")
_g2p = G2p()
_normalizer = None
